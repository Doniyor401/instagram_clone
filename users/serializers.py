...
class LoginSerializer(TokenObtainPairSerializer):
    ...
    def auth_validate(self, data):
        ...
        if check_user_type(user_input) == 'username':
            username = user_input
        elif check_user_type(user_input) == "email":  # Anora@gmail.com   -> anOra@gmail.com = bir xil qiymat dib qabul qiladi 2lasiniyam
            ...
            data = {
                'success': True,
                'message': "Siz email, username yoki telefon raqamni jonatishingiz kerak"
            }
            raise ValidationError(data)
