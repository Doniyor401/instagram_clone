...
class VerifyAPIView(APIView):
    ...
    def check_verify(user, code):
        ...
        if not verifies.exists():
            data = {
                "message": "Tastiqlash kodingiz xato yoki eskirgan",
            }
...
class GetNewVerification(APIView):
    ...
    def get(self, request, *args, **kwargs):
        ...
        if user.auth_type == VIA_EMAIL:
            ...
            data = {
                "message": "Email yoki telefon raqami notog'ri"
            }
            raise ValidationError(data)
        return Response(
            {
                "success": True,
                "message": "Tastiqlash kodinginz qaytadan jo'natilindi"
            }
        )
...
class ChangeUserPhotoView(APIView):
    ...
    def put(self, request, *args, **kwargs):
        ...
        if serializer.is_valid():
            ...
            return Response({
                "message": "Rasm muvaffiqiyatli o'zgartirildi"
            }, status=200)
        return Response(
...
class ForgotPasswordView(APIView):
    ...
    def post(self, request, *args, **kwargs):
        ...
        return Response({
            "success": True,
            "message": "Tastiqlash kodi muvaffaqiyatli yuborildi",
            "access": user.token()['access'],
